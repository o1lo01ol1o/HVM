...
#define _CHURCHAND_ (54)
#define _IFZEROELSE_ (41)
#define _C2_ (44)
#define _NATSUCC_ (31)
#define _MAIN0_ (36)
#define _INTTOCHURCHINT_ (45)
#define _CHURCHOR_ (52)
#define _CHURCHFST_ (53)
#define _CHURCHISZERO_ (28)
#define _ADDNAT_ (35)
#define _NATZERO_ (40)
#define _CHURCHTONAT_ (56)
#define _MAIN_ (49)
#define _NATONE_ (33)
#define _CTONAT_ (37)
#define _CHURCHIFELSE_ (39)
#define _CHURCHFALSE_ (29)
#define _CHURCHSND_ (51)
#define _CHURCHTRUE_ (30)
#define _ONEPLUSONE_ (34)
#define _CHURCHINTNEG_ (55)
#define _NATTOCHURCH_ (47)
#define _CHURCHNATTOCHURCHINT_ (46)
#define _CADD_ (43)
#define _C4_ (38)
#define _ONEPLUSONETWICE_ (50)
#define _MULTNAT_ (32)
#define _CHURCHPAIR_ (48)
#define _C1_ (42)
    ...
    if (init == 1) {
      switch (get_tag(term)) {
        ...
        case FUN: {
          ...
          {
            case _CHURCHAND_: {
              if (ask_ari(mem, term) == 0) {
                init = 0;
                continue;
              }
            };
            case _IFZEROELSE_: {
              if (ask_ari(mem, term) == 3) {
                stk_push(&stack, host);
                host = get_loc(term, 0);
                continue;
              }
          ...
          //GENERATED_REWRITE_RULES_STEP_1_START//
          {
            case _CHURCHAND_: {
              if (1) {
                ...
                link(mem, app_3 + 0, Var(lam_0));
                link(mem, app_3 + 1, Var(lam_1));
                u64 cal_4 = alloc(mem, 0);
                u64 app_2 = alloc(mem, 2);
                link(mem, app_2 + 0, App(app_3));
                link(mem, app_2 + 1, Cal(0, 29, cal_4));
                link(mem, lam_1 + 1, App(app_2));
            ...
            case _C2_: {
              if (1) {
                ...
                link(mem, app_1 + 0, Cal(0, 43, cal_2));
                link(mem, app_1 + 1, Cal(0, 42, cal_3));
                u64 cal_4 = alloc(mem, 0);
                u64 app_0 = alloc(mem, 2);
                link(mem, app_0 + 0, App(app_1));
                link(mem, app_0 + 1, Cal(0, 42, cal_4));
                u64 done = App(app_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _NATSUCC_: {
              if (1) {
                ...
                u64 dp0_3;
                u64 dp1_4;
                if (get_tag(cpy_2) == NUM) {
                  inc_cost(mem);
                  dp0_3 = cpy_2;
                  dp1_4 = cpy_2;
                } else {
                  u64 dup_5 = alloc(mem, 3);
                  u64 col_6 = gen_dupk(mem);
                  link(mem, dup_5 + 2, cpy_2);
                  dp0_3 = Dp0(col_6, dup_5);
                  dp1_4 = Dp1(col_6, dup_5);
                }
                u64 lam_7 = alloc(mem, 2);
                u64 app_10 = alloc(mem, 2);
                link(mem, app_10 + 0, Var(lam_0));
                link(mem, app_10 + 1, dp1_4);
                u64 app_9 = alloc(mem, 2);
                link(mem, app_9 + 0, App(app_10));
                link(mem, app_9 + 1, Var(lam_7));
                u64 app_8 = alloc(mem, 2);
                link(mem, app_8 + 0, dp0_3);
                link(mem, app_8 + 1, App(app_9));
                link(mem, lam_7 + 1, App(app_8));
                link(mem, lam_1 + 1, Lam(lam_7));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
            ...
            case _MAIN0_: {
              if (1) {
                ...
                link(mem, cal_1 + 0, Cal(0, 38, cal_0));
                u64 done = Cal(1, 37, cal_1);
                link(mem, host, done);
            ...
            case _INTTOCHURCHINT_: {
              if (1) {
                ...
                u64 cal_1 = alloc(mem, 1);
                link(mem, cal_1 + 0, Cal(1, 47, cal_0));
                u64 done = Cal(1, 46, cal_1);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _CHURCHOR_: {
              if (1) {
                ...
                u64 app_3 = alloc(mem, 2);
                link(mem, app_3 + 0, Var(lam_0));
                link(mem, app_3 + 1, Cal(0, 30, cal_4));
                u64 app_2 = alloc(mem, 2);
                link(mem, app_2 + 0, App(app_3));
                link(mem, app_2 + 1, Var(lam_1));
                link(mem, lam_1 + 1, App(app_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _CHURCHFST_: {
              if (1) {
                ...
                link(mem, lam_2 + 0, Era());
                link(mem, lam_2 + 1, Var(lam_1));
                link(mem, lam_1 + 1, Lam(lam_2));
                u64 app_0 = alloc(mem, 2);
                link(mem, app_0 + 0, ask_arg(mem, term, 0));
                link(mem, app_0 + 1, Lam(lam_1));
                u64 done = App(app_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
            ...
            case _CHURCHISZERO_: {
              if (1) {
                ...
                u64 cal_3 = alloc(mem, 0);
                link(mem, lam_2 + 0, Era());
                link(mem, lam_2 + 1, Cal(0, 29, cal_3));
                u64 app_1 = alloc(mem, 2);
                link(mem, app_1 + 0, ask_arg(mem, term, 0));
                link(mem, app_1 + 1, Lam(lam_2));
                u64 cal_4 = alloc(mem, 0);
                u64 app_0 = alloc(mem, 2);
                link(mem, app_0 + 0, App(app_1));
                link(mem, app_0 + 1, Cal(0, 30, cal_4));
                u64 done = App(app_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
            ...
            case _ADDNAT_: {
              if (1) {
                ...
                u64 dp0_4;
                u64 dp1_5;
                if (get_tag(cpy_3) == NUM) {
                  inc_cost(mem);
                  dp0_4 = cpy_3;
                  dp1_5 = cpy_3;
                } else {
                  u64 dup_6 = alloc(mem, 3);
                  u64 col_7 = gen_dupk(mem);
                  link(mem, dup_6 + 2, cpy_3);
                  dp0_4 = Dp0(col_7, dup_6);
                  dp1_5 = Dp1(col_7, dup_6);
                }
                u64 lam_8 = alloc(mem, 2);
                u64 app_10 = alloc(mem, 2);
                link(mem, app_10 + 0, Var(lam_0));
                link(mem, app_10 + 1, dp0_4);
                u64 app_12 = alloc(mem, 2);
                link(mem, app_12 + 0, Var(lam_1));
                link(mem, app_12 + 1, dp1_5);
                u64 app_11 = alloc(mem, 2);
                link(mem, app_11 + 0, App(app_12));
                link(mem, app_11 + 1, Var(lam_8));
                u64 app_9 = alloc(mem, 2);
                link(mem, app_9 + 0, App(app_10));
                link(mem, app_9 + 1, App(app_11));
                link(mem, lam_8 + 1, App(app_9));
                link(mem, lam_2 + 1, Lam(lam_8));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _NATZERO_: {
              if (1) {
                ...
                u64 lam_0 = alloc(mem, 2);
                u64 lam_1 = alloc(mem, 2);
                link(mem, lam_1 + 1, Var(lam_1));
                link(mem, lam_0 + 0, Era());
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
            ...
            case _CHURCHTONAT_: {
              if (1) {
                ...
                u64 lam_2 = alloc(mem, 2);
                u64 ret_3;
                if (get_tag(Var(lam_2)) == NUM && get_tag(Num(1ull)) == NUM) {
                  ret_3 = Num(get_num(Var(lam_2)) + get_num(Num(1ull)));
                  inc_cost(mem);
                } else {
                  u64 op2_4 = alloc(mem, 2);
                  link(mem, op2_4 + 0, Var(lam_2));
                  link(mem, op2_4 + 1, Num(1ull));
                  ret_3 = Op2(ADD, op2_4);
                }
            ...
            case _MAIN_: {
              if (1) {
                ...
                u64 app_1 = alloc(mem, 2);
                link(mem, app_1 + 0, Cal(0, 43, cal_2));
                link(mem, app_1 + 1, Cal(0, 44, cal_3));
                u64 cal_4 = alloc(mem, 0);
                u64 app_0 = alloc(mem, 2);
                link(mem, app_0 + 0, App(app_1));
                link(mem, app_0 + 1, Cal(0, 44, cal_4));
                u64 cal_5 = alloc(mem, 1);
                link(mem, cal_5 + 0, App(app_0));
                u64 done = Cal(1, 37, cal_5);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                collect(mem, ask_arg(mem, term, 0));
                init = 1;
            ...
            case _CHURCHIFELSE_: {
              if (1) {
                ...
                link(mem, app_4 + 0, Var(lam_0));
                link(mem, app_4 + 1, Var(lam_1));
                u64 app_3 = alloc(mem, 2);
                link(mem, app_3 + 0, App(app_4));
                link(mem, app_3 + 1, Var(lam_2));
                link(mem, lam_2 + 1, App(app_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
            ...
            case _CHURCHSND_: {
              if (1) {
                ...
                u64 lam_1 = alloc(mem, 2);
                u64 lam_2 = alloc(mem, 2);
                link(mem, lam_2 + 1, Var(lam_2));
                link(mem, lam_1 + 0, Era());
                link(mem, lam_1 + 1, Lam(lam_2));
                u64 app_0 = alloc(mem, 2);
                link(mem, app_0 + 0, ask_arg(mem, term, 0));
                link(mem, app_0 + 1, Lam(lam_1));
            ...
            case _ONEPLUSONE_: {
              if (1) {
                ...
                if (get_tag(cpy_0) == NUM) {
                  ...
                  u64 dup_4 = alloc(mem, 3);
                  u64 col_5 = gen_dupk(mem);
                  link(mem, dup_4 + 2, cpy_0);
                  dp0_1 = Dp0(col_5, dup_4);
                  dp1_2 = Dp1(col_5, dup_4);
                }
                u64 cal_6 = alloc(mem, 0);
                u64 app_8 = alloc(mem, 2);
                link(mem, app_8 + 0, Cal(0, 35, cal_6));
                link(mem, app_8 + 1, dp0_1);
            ...
            case _CHURCHINTNEG_: {
              if (1) {
                ...
                u64 cal_5 = alloc(mem, 1);
                link(mem, cal_5 + 0, dp0_1);
                u64 cal_6 = alloc(mem, 1);
                link(mem, cal_6 + 0, dp1_2);
                u64 cal_7 = alloc(mem, 2);
                link(mem, cal_7 + 0, Cal(1, 51, cal_5));
                link(mem, cal_7 + 1, Cal(1, 53, cal_6));
                u64 done = Cal(2, 48, cal_7);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _NATTOCHURCH_: {
              ...
              if ((get_tag(ask_arg(mem, term, 0)) == CTR || get_tag(ask_arg(mem, term, 0)) == NUM)) {
                inc_cost(mem);
                u64 ret_0;
                if (get_tag(ask_arg(mem, term, 0)) == NUM && get_tag(Num(1ull)) == NUM) {
                  ret_0 = Num(get_num(ask_arg(mem, term, 0)) - get_num(Num(1ull)));
                  inc_cost(mem);
                } else {
                  u64 op2_1 = alloc(mem, 2);
                  link(mem, op2_1 + 0, ask_arg(mem, term, 0));
                  link(mem, op2_1 + 1, Num(1ull));
                  ret_0 = Op2(SUB, op2_1);
                }
                ...
                u64 app_12 = alloc(mem, 2);
                link(mem, app_12 + 0, Cal(1, 47, cal_2));
                link(mem, app_12 + 1, dp1_6);
                u64 app_11 = alloc(mem, 2);
                link(mem, app_11 + 0, App(app_12));
                link(mem, app_11 + 1, Var(lam_9));
                u64 app_10 = alloc(mem, 2);
                link(mem, app_10 + 0, dp0_5);
                link(mem, app_10 + 1, App(app_11));
                link(mem, lam_9 + 1, App(app_10));
                link(mem, lam_3 + 1, Lam(lam_9));
                u64 done = Lam(lam_3);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
            ...
            case _CHURCHNATTOCHURCHINT_: {
              if (1) {
                ...
                link(mem, cal_2 + 1, Lam(lam_0));
                u64 done = Cal(2, 48, cal_2);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 1);
                init = 1;
                continue;
            ...
            case _ONEPLUSONETWICE_: {
              if (1) {
                ...
                u64 cal_2 = alloc(mem, 0);
                u64 app_4 = alloc(mem, 2);
                link(mem, app_4 + 0, Cal(0, 35, cal_2));
                link(mem, app_4 + 1, Cal(0, 34, cal_1));
                u64 app_3 = alloc(mem, 2);
                link(mem, app_3 + 0, App(app_4));
                link(mem, app_3 + 1, Cal(0, 34, cal_0));
                u64 done = App(app_3);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 0);
                init = 1;
            ...
            case _MULTNAT_: {
              if (1) {
                ...
                u64 lam_2 = alloc(mem, 2);
                u64 app_4 = alloc(mem, 2);
                link(mem, app_4 + 0, Var(lam_1));
                link(mem, app_4 + 1, Var(lam_2));
                u64 app_3 = alloc(mem, 2);
                link(mem, app_3 + 0, Var(lam_0));
                link(mem, app_3 + 1, App(app_4));
                link(mem, lam_2 + 1, App(app_3));
                link(mem, lam_1 + 1, Lam(lam_2));
                link(mem, lam_0 + 1, Lam(lam_1));
                u64 done = Lam(lam_0);
            ...
            case _CHURCHPAIR_: {
              if (1) {
                ...
                link(mem, app_1 + 1, ask_arg(mem, term, 1));
                link(mem, lam_0 + 1, App(app_1));
                u64 done = Lam(lam_0);
                link(mem, host, done);
                clear(mem, get_loc(term, 0), 2);
                init = 1;
...
int main(int argc, char* argv[]) {
  ...
  id_to_name_data[39] = "ChurchIfElse";
  id_to_name_data[49] = "Main";
  id_to_name_data[24] = "Kind.Term.ctE";
  id_to_name_data[20] = "Kind.Term.ctA";
  id_to_name_data[28] = "ChurchIsZero";
  id_to_name_data[12] = "Kind.Term.ct2";
  id_to_name_data[35] = "AddNat";
  id_to_name_data[21] = "Kind.Term.ctB";
  id_to_name_data[36] = "Main0";
  id_to_name_data[45] = "IntToChurchInt";
  id_to_name_data[0] = "HVM.log";
  id_to_name_data[16] = "Kind.Term.ct6";
  id_to_name_data[53] = "ChurchFst";
  id_to_name_data[32] = "MultNat";
  id_to_name_data[5] = "IO.do_input";
  id_to_name_data[44] = "C2";
  id_to_name_data[13] = "Kind.Term.ct3";
  id_to_name_data[3] = "String.cons";
  id_to_name_data[15] = "Kind.Term.ct5";
  id_to_name_data[37] = "CToNat";
  id_to_name_data[42] = "C1";
  id_to_name_data[55] = "ChurchIntNeg";
  id_to_name_data[50] = "OnePlusOneTwice";
  id_to_name_data[41] = "IfZeroElse";
  id_to_name_data[4] = "IO.done";
  id_to_name_data[40] = "NatZero";
  id_to_name_data[51] = "ChurchSnd";
  id_to_name_data[48] = "ChurchPair";
  ...
  id_to_name_data[54] = "ChurchAND";
  id_to_name_data[14] = "Kind.Term.ct4";
  id_to_name_data[33] = "NatOne";
  id_to_name_data[38] = "C4";
  id_to_name_data[46] = "ChurchNatToChurchInt";
  id_to_name_data[47] = "NatToChurch";
  id_to_name_data[43] = "Cadd";
  ...
  id_to_name_data[29] = "ChurchFalse";
  id_to_name_data[25] = "Kind.Term.ctF";
  id_to_name_data[34] = "OnePlusOne";
  id_to_name_data[52] = "ChurchOR";
  id_to_name_data[56] = "ChurchToNat";
  id_to_name_data[31] = "NatSucc";
  id_to_name_data[8] = "IO.do_store";
  id_to_name_data[30] = "ChurchTrue";


  // Id-to-Arity map
  const u64 id_to_arity_size = 57;
  u64 id_to_arity_data[id_to_arity_size];
  id_to_arity_data[38] = 0;
  id_to_arity_data[46] = 1;
  id_to_arity_data[37] = 1;
  id_to_arity_data[52] = 0;
  id_to_arity_data[47] = 1;
  id_to_arity_data[42] = 0;
  id_to_arity_data[7] = 3;
  id_to_arity_data[32] = 0;
  id_to_arity_data[41] = 3;
  id_to_arity_data[35] = 0;
  id_to_arity_data[30] = 0;
  id_to_arity_data[53] = 1;
  id_to_arity_data[48] = 2;
  id_to_arity_data[40] = 0;
  id_to_arity_data[34] = 0;
  id_to_arity_data[4] = 1;
  id_to_arity_data[8] = 3;
  id_to_arity_data[39] = 0;
  id_to_arity_data[49] = 1;
  id_to_arity_data[55] = 1;
  id_to_arity_data[0] = 2;
  id_to_arity_data[33] = 0;
  id_to_arity_data[43] = 0;
  id_to_arity_data[45] = 1;
  id_to_arity_data[56] = 1;
  id_to_arity_data[6] = 2;
  id_to_arity_data[29] = 0;
  id_to_arity_data[9] = 2;
  id_to_arity_data[3] = 2;
  id_to_arity_data[36] = 1;
  id_to_arity_data[28] = 1;
  id_to_arity_data[2] = 0;
  id_to_arity_data[31] = 0;
  id_to_arity_data[44] = 0;
  id_to_arity_data[54] = 0;
  id_to_arity_data[5] = 1;
  id_to_arity_data[1] = 2;
  id_to_arity_data[51] = 1;
  id_to_arity_data[50] = 0;
